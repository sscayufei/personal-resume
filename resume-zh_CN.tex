...
% Personal information is stored locally to avoid committing private data.
% If personal-info.tex does not exist, use the public example file.
\IfFileExists{personal-info.tex}{
  \input{personal-info.tex}
}{
  \input{personal-info.tex.example}
}
